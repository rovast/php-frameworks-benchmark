...
run `ab -n 1 -c 1 http://127.0.0.1:8003/api/setPRedis`
run `ab -n 1000 -c 1 http://127.0.0.1:8003/api/predis`
...
run `ab -n 50000 -c 1 http://127.0.0.1:8003/api/predis`
...
Concurrency Level:      1
Time taken for tests:   41.957 seconds
Complete requests:      50000
Failed requests:        0
Total transferred:      11050000 bytes
HTML transferred:       550000 bytes
Requests per second:    1191.70 [#/sec] (mean)
...
```
---
run `ab -n 50000 -c 5 http://127.0.0.1:8003/api/predis`
...
Concurrency Level:      5
Time taken for tests:   9.751 seconds
Complete requests:      50000
Failed requests:        0
Total transferred:      11050000 bytes
HTML transferred:       550000 bytes
Requests per second:    5127.63 [#/sec] (mean)
...
Connection Times (ms)
              min  mean[+/-sd] median   max
Connect:        0    0   0.0      0       3
Processing:     1    1   1.0      1     209
Waiting:        1    1   1.0      1     209
Total:          1    1   1.0      1     209
...
```
---
run `ab -n 50000 -c 10 http://127.0.0.1:8003/api/predis`
...
Concurrency Level:      10
Time taken for tests:   8.881 seconds
Complete requests:      50000
Failed requests:        0
Total transferred:      11050000 bytes
HTML transferred:       550000 bytes
Requests per second:    5630.26 [#/sec] (mean)
Time per request:       1.776 [ms] (mean)
Time per request:       0.178 [ms] (mean, across all concurrent requests)
Transfer rate:          1215.12 [Kbytes/sec] received
...
```
---
run `ab -n 50000 -c 20 http://127.0.0.1:8003/api/predis`
