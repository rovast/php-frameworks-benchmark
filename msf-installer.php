...
$defaultApplicationDir = '/home/luohao/Github/php-frameworks-benchmark/msf-demo';
$defaultPort           = 8090;
// 检查php
if (empty($phpBinPath)) {
...
writeLine("Input application env (will write to " . "~/.bashrc): ");
...
shell_exec("sed -i 's/export\ MSF_ENV=\w\+//g' " . '~/.bashrc');
shell_exec("echo export MSF_ENV=" . $applicationEnv . '>>' .  '~/.bashrc');
